...
{
    m_nBDMNum = BDM_NUM;                //24
    m_nDUNum = DU_NUM;                  //4
    m_nPositionSize = POSITION_SIZE;    //256
    m_nCrystalSize = CRYSTAL_SIZE;      //13
...
void UPositionMap::KMeanAlgorithm1D(uint32* f_pMap, Point* f_pPoint)
{
	...
	uint8 temp[m_nCrystalSize] = {42, 48, 63, 76, 93, 109, 127, 143, 158, 176, 190, 205, 213};
